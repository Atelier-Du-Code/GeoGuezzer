...
>(({ className, ...props }, ref) => (
    <SelectPrimitive.ScrollUpButton
        ref={ref}
        className={cn('flex cursor-default text-text items-center justify-center py-1', className)}
        {...props}
    >
...
>(({ className, ...props }, ref) => (
    <SelectPrimitive.ScrollDownButton
        ref={ref}
        className={cn('flex cursor-default text-text items-center justify-center py-1 font-base', className)}
        {...props}
    >
        <ChevronDown className="h-4 w-4" />
    </SelectPrimitive.ScrollDownButton>
...
>(({ className, ...props }, ref) => (
    <SelectPrimitive.Label
        ref={ref}
        className={cn('border-2 border-transparent py-1.5 pl-8 pr-2 text-sm font-base text-black/80', className)}
        {...props}
    />
));
...
>(({ className, ...props }, ref) => (
    <SelectPrimitive.Separator ref={ref} className={cn('-mx-1 my-1 h-px bg-border dark:border-darkBorder', className)} {...props} />
));
